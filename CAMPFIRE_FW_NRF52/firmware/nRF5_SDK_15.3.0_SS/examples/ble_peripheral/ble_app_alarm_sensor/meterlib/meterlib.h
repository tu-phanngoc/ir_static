 ...
 ******************************************************************************/
#define PWR_SENS_THR0(x)   FRAC32(((x)/(U_MAX*I0_MAX/2.0)))
#define PWR_SENS_THR1(x)   FRAC32(((x)/(U_MAX*I1_MAX/2.0)))
#define PWR_SENS_THR2(x)   FRAC32(((x)/(U_MAX*I2_MAX/2.0)))
#define PWR_SENS_THR3(x)   FRAC32(((x)/(U_MAX*I3_MAX/2.0)))

#define KWH_DISP_RES0(x)   FRAC48(((1e3/(x))/(U_MAX*I0_MAX/3600/CALCFREQ)))		//(123.11)	//FRAC48(((800.0/(x))/(0.006498)))		//FRAC48(((800.0/(x))/(U_MAX*I0_MAX/3600/CALCFREQ)))
#define KWH_DISP_RES1(x)   FRAC48(((8e2/(x))/(U_MAX*I1_MAX/3600/CALCFREQ)))
#define KWH_DISP_RES2(x)   FRAC48(((8e2/(x))/(U_MAX*I2_MAX/3600/CALCFREQ)))
#define KWH_DISP_RES3(x)   FRAC48(((8e2/(x))/(U_MAX*I2_MAX/3600/CALCFREQ)))
#define KWH_PULS_NUM0(x)   FRAC48(((4e2/(x))/(U_MAX*I0_MAX/3600/CALCFREQ)))
#define KWH_PULS_NUM1(x)   FRAC48(((4e2/(x))/(U_MAX*I1_MAX/3600/CALCFREQ)))
#define KWH_PULS_NUM2(x)   FRAC48(((4e2/(x))/(U_MAX*I2_MAX/3600/CALCFREQ)))
#define KWH_PULS_NUM3(x)   FRAC48(((4e2/(x))/(U_MAX*I3_MAX/3600/CALCFREQ)))
