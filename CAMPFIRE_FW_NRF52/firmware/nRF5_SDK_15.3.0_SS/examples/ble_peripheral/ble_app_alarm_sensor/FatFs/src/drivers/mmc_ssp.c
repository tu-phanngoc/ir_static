...
#define FCLK_FAST() {SPI_InitHighFreq(2);}
#define FCLK_SLOW() {SPI_InitLowFreq(2);}
...
static uint8_t powerOffFlag = 1;
#define xchg_spi(x)					halSpiWriteByte(SPI2,x)
