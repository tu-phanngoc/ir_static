...
static const uint32_t enc_table[256] = {   
...
static  const uint32_t dec_table[256] = {    
...
uint32_t WORD8_TO_WORD32(uint32_t b0,uint32_t b1,uint32_t b2,uint32_t b3)
{
...
{   
    ...
    copy1 = WORD8_TO_WORD32(
						byte3(key[1]),
						byte2(key[1]),
						byte1(key[1]),
						byte0(key[1]));   
    copy2 = WORD8_TO_WORD32(
						byte3(key[2]),
						byte2(key[2]),
						byte1(key[2]),
						byte0(key[2]));
		copy3 = WORD8_TO_WORD32(
						byte3(key[3]),
						byte2(key[3]),
						byte1(key[3]),
						byte0(key[3]));
...
{     
    ...
    uint32_t f2,f4,f8;   
		...
		input_pointer[0] = WORD8_TO_WORD32(
			byte3(input_pointer[0]),
			byte2(input_pointer[0]),
			byte1(input_pointer[0]),
			byte0(input_pointer[0]));
		input_pointer[1] = WORD8_TO_WORD32(
			byte3(input_pointer[1]),
			byte2(input_pointer[1]),
			byte1(input_pointer[1]),
			byte0(input_pointer[1]));
		input_pointer[2] = WORD8_TO_WORD32(
			byte3(input_pointer[2]),
			byte2(input_pointer[2]),
			byte1(input_pointer[2]),
			byte0(input_pointer[2]));
		input_pointer[3] = WORD8_TO_WORD32(
			byte3(input_pointer[3]),
			byte2(input_pointer[3]),
			byte1(input_pointer[3]),
			byte0(input_pointer[3]));
    ...
    t3 = WORD8_TO_WORD32( InvSbox[byte0(s3)],   
                         ...
                         InvSbox[byte2(s1)],   
                         InvSbox[byte3(s0)]) ^ local_pointer[7];   
    output_pointer[0] = WORD8_TO_WORD32(
			byte3(t0),
			byte2(t0),
			byte1(t0),
			byte0(t0));
		output_pointer[1] = WORD8_TO_WORD32(
			byte3(t1),
			byte2(t1),
			byte1(t1),
			byte0(t1));
		output_pointer[2] = WORD8_TO_WORD32(
			byte3(t2),
			byte2(t2),
			byte1(t2),
			byte0(t2));
		output_pointer[3] = WORD8_TO_WORD32(
			byte3(t3),
			byte2(t3),
			byte1(t3),
			byte0(t3));     
