...
const AMPM_GSM_AT_CMD_PACKET_TYPE ampmAtCmd_AT_CLVL = {"AT+CLVL=90\r",NULL,NULL,NULL,"OK","ERROR"};//delay = 100,timeout = 1000,retry = 1
...
void Ampm_VoiceCallStartRecvCall(void)
{
	...
	incomingCall.timeout = 120;
	incomingCall.timeoutReload = 120;
